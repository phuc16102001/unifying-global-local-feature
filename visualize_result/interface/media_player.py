...
import os
from PyQt5.QtWidgets import QInputDialog, QWidget, QPushButton, QStyle, QSlider, QHBoxLayout, QVBoxLayout, QFileDialog
...
class MediaPlayer(QWidget):
	...
	def open_file(self):
		...
		if filename != '':
			...
			self.path_label = os.path.dirname(filename) + "/results_spotting.json"
